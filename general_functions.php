<?php
    ...
    function account_created_email($name, $email, $uname, $password) {
        ...
        $message .= "<html lang=\"en-UK\">
					   <body>
					     <p>Dear $name,</p><br>
                         <p>An account has been made for you on the <a href='http://csthesis.liacs.leidenuniv.nl'>LIACS Graduation Application</a>.</p>
